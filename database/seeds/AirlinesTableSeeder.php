...
use App\Models\Fligths\Airline;
...
class AirlinesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Airline::create([
            ...
            "iata" => "4C",
            "icao" => "ARE",
            "callsign" => " Aerovias de Integracion Regional S.A",
            "country_id" => 47
        ]);
        Airline::create([
            "id" => 13,
        ...
        Airline::create([
            ...
            "alias" => "Federal State Budget Inst",
            "iata" => "",
            "icao" => "RSD",
            "callsign" => "STATE AERO",
            "country_id" => 177
